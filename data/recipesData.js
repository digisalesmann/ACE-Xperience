...
export const allRecipes = [
    { id: 1, title: "Classic Meat Pie", category: "Baking", prepTime: "30 min", cookTime: "1 hr", tags: ["Savoury", "Snack", "Beef"], image: "meatt.jpg", slug: "classic-meat-pie", excerpt: "Flaky crust enclosing perfectly seasoned savory beef filling. A comforting classic.", rating: 4.8, difficulty: "Medium" },
    { id: 2, title: "Creamy Chicken Pie", category: "Baking", prepTime: "35 min", cookTime: "1 hr 15 min", tags: ["Savoury", "Dinner", "Chicken"], image: "chick.jpg", slug: "creamy-chicken-pie", excerpt: "Tender chicken in a rich, velvety cream sauce, baked under a golden puff pastry.", rating: 4.5, difficulty: "Medium" },
    { id: 3, title: "Soft Sliced Bread", category: "Baking", prepTime: "20 min", cookTime: "4 hr", tags: ["Bread", "Vegan", "Fermented"], image: "sour.jpg", slug: "sourdough-bread", excerpt: "Achieve the perfect open crumb and signature tangy flavor with this method.", rating: 4.9, difficulty: "Hard" },
    ...
    { id: 8, title: "Savory Sausage Rolls", category: "Baking", prepTime: "20 min", cookTime: "40 min", tags: ["Savoury", "Snack", "Pork"], image: "saucee.jpg", slug: "sausage-rolls", excerpt: "Juicy, spiced sausage meat wrapped in golden puff pastry. Excellent appetizer.", rating: 4.6, difficulty: "Easy" },
    ...
    { id: 13, title: "Party Jollof Rice", category: "Main Dish", prepTime: "45 min", cookTime: "1 hr 15 min", tags: ["Rice", "Traditional", "Celebration"], image: "coco.jpg", slug: "party-jollof-rice", excerpt: "The iconic smoky, spiced tomato-based rice. Master the perfect party recipe.", rating: 5.0, difficulty: "Medium" },
    ...
    { id: 17, title: "Classic Tomato Stew", category: "Side Dish", prepTime: "20 min", cookTime: "1 hr", tags: ["Sauce", "Staple", "Freezable"], image: "steww.jpg", slug: "tomato-stew", excerpt: "The foundational Nigerian stew. Versatile and essential for pairing with staples.", rating: 4.7, difficulty: "Easy" },
    ...
    { id: 22, title: "Fish Pepper Soup", category: "Main Dish", prepTime: "15 min", cookTime: "35 min", tags: ["Spicy", "Soup", "Light"], image: "fishh.jpg", slug: "fish-pepper-soup", excerpt: "A light, intensely flavored, and spicy broth with fresh fish. Perfect for chilly evenings.", rating: 4.7, difficulty: "Medium" },
    { id: 23, title: "Parmesan Rolls", category: "Baking", prepTime: "30 min", cookTime: "20 min", tags: ["Bread", "Savoury", "Side"], image: "parm.jpg", slug: "garlic-parmesan-rolls", excerpt: "Soft, warm rolls drenched in garlic butter and Parmesan cheese. Highly addictive.", rating: 4.5, difficulty: "Easy" },
    { id: 25, title: "Yam Porridge", category: "Main Dish", prepTime: "20 min", cookTime: "40 min", tags: ["Traditional", "Comfort", "Tuber"], image: "yamm.jpg", slug: "yam-porridge", excerpt: "Creamy, tomato-based Nigerian porridge made with soft pounded yams.", rating: 4.4, difficulty: "Medium" },
]